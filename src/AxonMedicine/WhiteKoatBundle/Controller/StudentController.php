...
// always check session.
        ...
        } else
        {
            ...
            $libtypes = $this->getLibTypes();

            return $this->render('AxonMedicineWhiteKoatBundle:Default:student.main.html.twig', array('name' => $loginInfo->getUsername(), 'libtypes' => $libtypes));
        }
    }
...
// always check session.
        ...
        } else
        {
            ...
            $selectedDrugOption = $request->get('drsrch');

            $selectedDiseaseOption = $request->get('disrch');
