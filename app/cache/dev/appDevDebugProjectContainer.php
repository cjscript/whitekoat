...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'whitekoat_actionlib_service' => 'getWhitekoatActionlibServiceService',
            'whitekoat_aliaslib_service' => 'getWhitekoatAliaslibServiceService',
            'whitekoat_classlib_service' => 'getWhitekoatClasslibServiceService',
            'whitekoat_dcard_service' => 'getWhitekoatDcardServiceService',
            'whitekoat_diseasecard_service' => 'getWhitekoatDiseasecardServiceService',
            'whitekoat_diseaselib_service' => 'getWhitekoatDiseaselibServiceService',
            'whitekoat_druglib_service' => 'getWhitekoatDruglibServiceService',
            'whitekoat_login_service' => 'getWhitekoatLoginServiceService',
            'whitekoat_moleculelib_service' => 'getWhitekoatMoleculelibServiceService',
            'whitekoat_relationship_service' => 'getWhitekoatRelationshipServiceService',
            'whitekoat_symptomlib_service' => 'getWhitekoatSymptomlibServiceService',
            'whitekoat_typelib_service' => 'getWhitekoatTypelibServiceService',
        );
        $this->aliases = array(
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/Dev/Netbeans.Projects/whitekoat/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Dev/Netbeans.Projects/whitekoat/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'whitekoat', 'user' => 'root', 'password' => '45drTweXsit24E3', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_006fe4dd36ce2fde2993497bf4a57b3580ed46aa71009f0e789efac046d67d63');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_006fe4dd36ce2fde2993497bf4a57b3580ed46aa71009f0e789efac046d67d63');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_006fe4dd36ce2fde2993497bf4a57b3580ed46aa71009f0e789efac046d67d63');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\Dev\\Netbeans.Projects\\whitekoat\\src\\AxonMedicine\\WhiteKoatBundle\\Entity')), 'AxonMedicine\\WhiteKoatBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('AxonMedicineWhiteKoatBundle' => 'AxonMedicine\\WhiteKoatBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/doctrine/orm/Proxies');
        $e->setProxyNamespace('Proxies');
        $e->setAutoGenerateProxyClasses(true);
        $e->setClassMetadataFactoryName('Doctrine\\ORM\\Mapping\\ClassMetadataFactory');
        $e->setDefaultRepositoryClassName('Doctrine\\ORM\\EntityRepository');
        $e->setNamingStrategy(new \Doctrine\ORM\Mapping\DefaultNamingStrategy());
        $e->addCustomStringFunction('GROUP_CONCAT', 'DoctrineExtensions\\Query\\Mysql\\GroupConcat');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Dev/Netbeans.Projects/whitekoat/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Dev/Netbeans.Projects/whitekoat/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Dev/Netbeans.Projects/whitekoat/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Dev/Netbeans.Projects/whitekoat/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Dev/Netbeans.Projects/whitekoat/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Dev\\Netbeans.Projects\\whitekoat\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\Dev\\Netbeans.Projects\\whitekoat\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\Dev\\Netbeans.Projects\\whitekoat\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\Dev\\Netbeans.Projects\\whitekoat\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\Dev\\Netbeans.Projects\\whitekoat\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\Dev\\Netbeans.Projects\\whitekoat\\src\\AxonMedicine\\WhiteKoatBundle/Resources/views', 'AxonMedicineWhiteKoat');
        $instance->addPath('C:\\Dev\\Netbeans.Projects\\whitekoat\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\Dev\\Netbeans.Projects\\whitekoat\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/Dev/Netbeans.Projects/whitekoat/app/Resources/views');
        $instance->addPath('C:\\Dev\\Netbeans.Projects\\whitekoat\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    /**
     * Gets the 'whitekoat_actionlib_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AxonMedicine\WhiteKoatBundle\Service\ActionLibService A AxonMedicine\WhiteKoatBundle\Service\ActionLibService instance.
     */
    protected function getWhitekoatActionlibServiceService()
    {
        return $this->services['whitekoat_actionlib_service'] = new \AxonMedicine\WhiteKoatBundle\Service\ActionLibService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'whitekoat_aliaslib_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AxonMedicine\WhiteKoatBundle\Service\AliasLibService A AxonMedicine\WhiteKoatBundle\Service\AliasLibService instance.
     */
    protected function getWhitekoatAliaslibServiceService()
    {
        return $this->services['whitekoat_aliaslib_service'] = new \AxonMedicine\WhiteKoatBundle\Service\AliasLibService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'whitekoat_classlib_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AxonMedicine\WhiteKoatBundle\Service\ClassLibService A AxonMedicine\WhiteKoatBundle\Service\ClassLibService instance.
     */
    protected function getWhitekoatClasslibServiceService()
    {
        return $this->services['whitekoat_classlib_service'] = new \AxonMedicine\WhiteKoatBundle\Service\ClassLibService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'whitekoat_dcard_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AxonMedicine\WhiteKoatBundle\Service\DrugCardService A AxonMedicine\WhiteKoatBundle\Service\DrugCardService instance.
     */
    protected function getWhitekoatDcardServiceService()
    {
        return $this->services['whitekoat_dcard_service'] = new \AxonMedicine\WhiteKoatBundle\Service\DrugCardService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'whitekoat_diseasecard_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AxonMedicine\WhiteKoatBundle\Service\DiseaseCardService A AxonMedicine\WhiteKoatBundle\Service\DiseaseCardService instance.
     */
    protected function getWhitekoatDiseasecardServiceService()
    {
        return $this->services['whitekoat_diseasecard_service'] = new \AxonMedicine\WhiteKoatBundle\Service\DiseaseCardService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'whitekoat_diseaselib_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AxonMedicine\WhiteKoatBundle\Service\DiseaseLibService A AxonMedicine\WhiteKoatBundle\Service\DiseaseLibService instance.
     */
    protected function getWhitekoatDiseaselibServiceService()
    {
        return $this->services['whitekoat_diseaselib_service'] = new \AxonMedicine\WhiteKoatBundle\Service\DiseaseLibService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'whitekoat_druglib_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AxonMedicine\WhiteKoatBundle\Service\DrugLibService A AxonMedicine\WhiteKoatBundle\Service\DrugLibService instance.
     */
    protected function getWhitekoatDruglibServiceService()
    {
        return $this->services['whitekoat_druglib_service'] = new \AxonMedicine\WhiteKoatBundle\Service\DrugLibService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'whitekoat_login_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AxonMedicine\WhiteKoatBundle\Service\LoginService A AxonMedicine\WhiteKoatBundle\Service\LoginService instance.
     */
    protected function getWhitekoatLoginServiceService()
    {
        return $this->services['whitekoat_login_service'] = new \AxonMedicine\WhiteKoatBundle\Service\LoginService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'whitekoat_moleculelib_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AxonMedicine\WhiteKoatBundle\Service\MoleculeLibService A AxonMedicine\WhiteKoatBundle\Service\MoleculeLibService instance.
     */
    protected function getWhitekoatMoleculelibServiceService()
    {
        return $this->services['whitekoat_moleculelib_service'] = new \AxonMedicine\WhiteKoatBundle\Service\MoleculeLibService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'whitekoat_relationship_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AxonMedicine\WhiteKoatBundle\Service\RelationshipService A AxonMedicine\WhiteKoatBundle\Service\RelationshipService instance.
     */
    protected function getWhitekoatRelationshipServiceService()
    {
        return $this->services['whitekoat_relationship_service'] = new \AxonMedicine\WhiteKoatBundle\Service\RelationshipService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'whitekoat_symptomlib_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AxonMedicine\WhiteKoatBundle\Service\SymptomLibService A AxonMedicine\WhiteKoatBundle\Service\SymptomLibService instance.
     */
    protected function getWhitekoatSymptomlibServiceService()
    {
        return $this->services['whitekoat_symptomlib_service'] = new \AxonMedicine\WhiteKoatBundle\Service\SymptomLibService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'whitekoat_typelib_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AxonMedicine\WhiteKoatBundle\Service\TypeLibService A AxonMedicine\WhiteKoatBundle\Service\TypeLibService instance.
     */
    protected function getWhitekoatTypelibServiceService()
    {
        return $this->services['whitekoat_typelib_service'] = new \AxonMedicine\WhiteKoatBundle\Service\TypeLibService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Dev/Netbeans.Projects/whitekoat/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\Dev\\Netbeans.Projects\\whitekoat\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Dev/Netbeans.Projects/whitekoat/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev',
            'kernel.logs_dir' => 'C:/Dev/Netbeans.Projects/whitekoat/app/logs',
            'kernel.bundles' => array(
                ...
                'AxonMedicineWhiteKoatBundle' => 'AxonMedicine\\WhiteKoatBundle\\AxonMedicineWhiteKoatBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'whitekoat',
            'database_user' => 'root',
            'database_password' => '45drTweXsit24E3',
            ...
            'debug.container.dump' => 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\Dev\\Netbeans.Projects\\whitekoat\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/Dev/Netbeans.Projects/whitekoat/app/../web',
            'assetic.write_to' => 'C:/Dev/Netbeans.Projects/whitekoat/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Dev/Netbeans.Projects/whitekoat/app/cache/dev/doctrine/orm/Proxies',
            ...
            'whitekoat_login_service.class' => 'AxonMedicine\\WhiteKoatBundle\\Service\\LoginService',
            'whitekoat_druglib_service.class' => 'AxonMedicine\\WhiteKoatBundle\\Service\\DrugLibService',
            'whitekoat_classlib_service.class' => 'AxonMedicine\\WhiteKoatBundle\\Service\\ClassLibService',
            'whitekoat_dcard_service.class' => 'AxonMedicine\\WhiteKoatBundle\\Service\\DrugCardService',
            'whitekoat_diseasecard_service.class' => 'AxonMedicine\\WhiteKoatBundle\\Service\\DiseaseCardService',
            'whitekoat_diseaselib_service.class' => 'AxonMedicine\\WhiteKoatBundle\\Service\\DiseaseLibService',
            'whitekoat_moleculelib_service.class' => 'AxonMedicine\\WhiteKoatBundle\\Service\\MoleculeLibService',
            'whitekoat_symptomlib_service.class' => 'AxonMedicine\\WhiteKoatBundle\\Service\\SymptomLibService',
            'whitekoat_actionlib_service.class' => 'AxonMedicine\\WhiteKoatBundle\\Service\\ActionLibService',
            'whitekoat_aliaslib_service.class' => 'AxonMedicine\\WhiteKoatBundle\\Service\\AliasLibService',
            'whitekoat_typelib_service.class' => 'AxonMedicine\\WhiteKoatBundle\\Service\\TypeLibService',
            'whitekoat_relationship_service.class' => 'AxonMedicine\\WhiteKoatBundle\\Service\\RelationshipService',
