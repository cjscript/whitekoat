 ...
 */
class Librarytype extends \AxonMedicine\WhiteKoatBundle\Entity\Librarytype implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Librarytype $proxy) {
