...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // results_route_get
        if ($pathinfo === '/results') {
            return array (  '_controller' => 'AxonMedicine\\WhiteKoatBundle\\Controller\\HomepageController::renderResultsPage',  '_route' => 'results_route_get',);
        }
        ...
        if (0 === strpos($pathinfo, '/home')) {
            ...
            // homepage_route_get
            if ($pathinfo === '/home') {
                return array (  '_controller' => 'AxonMedicine\\WhiteKoatBundle\\Controller\\HomepageController::renderStudentHome',  '_route' => 'homepage_route_get',);
            }
